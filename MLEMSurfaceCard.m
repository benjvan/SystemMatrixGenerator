...
% Build surface cards for Bar Detector array
    ...
    PolimiParameters.DetectorYMin = -PolimiParameters.ScintillatorPlaneLength/2;
    PolimiParameters.DetectorYMax =PolimiParameters.ScintillatorPlaneLength/2;
    PolimiParameters.DetectorZMin = -PolimiParameters.ScintillatorPlaneLength/2;
    PolimiParameters.DetectorZMax = PolimiParameters.ScintillatorPlaneLength/2;
